                    ...
                    <div class="card-body">
                        <div class="d-flex flex-row">
                            ...
                            <div class="m-l-10 align-self-center">
                                ...
                                <a href="<?php echo base_url(); ?>employee/Employees" class="text-muted m-b-0">Xem Chi
                                    Tiết</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-row">
                            ...
                            <div class="m-l-10 align-self-center">
                                ...
                                <a href="<?php echo base_url(); ?>leave/Application" class="text-muted m-b-0">Xem Chi
                                    Tiết</a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex flex-row">
                            ...
                            <div class="m-l-10 align-self-center">
                                ...
                                <a href="<?php echo base_url(); ?>Projects/All_Projects" class="text-muted m-b-0">Xem
                                    Chi Tiết</a>
                            </div>
                        </div>
                    </div>
                            ...
                            <form method="post" action="add_todo" enctype="multipart/form-data" id="add_todo">
                                <div class="input-group">
                                    <input type="text" name="todo_data" class="form-control"
                                        style="border: 1px solid #fff !IMPORTANT;" placeholder="Nhập công việc mới...">
